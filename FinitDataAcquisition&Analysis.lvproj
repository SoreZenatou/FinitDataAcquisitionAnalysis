...
<Project Type="Project" LVVersion="20008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Type Definitions" Type="Folder">
			...
			<Item Name="Acquisition Configuration Setting.ctl" Type="VI" URL="../../../DataAcquisition&amp;Analysis/Acquisition Configuration Setting.ctl"/>
		</Item>
		<Item Name="Sub VI" Type="Folder">
			<Item Name="File Handling" Type="Folder">
				<Item Name="Configuration file" Type="Folder">
					<Item Name="Write Configuration  Data.vi" Type="VI" URL="../Configuration Files/Write Configuration  Data.vi"/>
					<Item Name="Read Configuration data0.vi" Type="VI" URL="../Configuration Files/Read Configuration data0.vi"/>
				</Item>
				<Item Name="Data Files" Type="Folder">
					<Item Name="Writing CSV File.vi" Type="VI" URL="../Data Files/Writing CSV File.vi"/>
					<Item Name="Read CSV File.vi" Type="VI" URL="../Data Files/Read CSV File.vi"/>
					<Item Name="Save Data File.vi" Type="VI" URL="../Data Files/Save Data File.vi"/>
				</Item>
				<Item Name="Recovery File" Type="Folder">
					<Item Name="Write Binary Recovery File.vi" Type="VI" URL="../Recovery Files/Write Binary Recovery File.vi"/>
					<Item Name="Read Binary recovery File.vi" Type="VI" URL="../Recovery Files/Read Binary recovery File.vi"/>
				</Item>
				<Item Name="File Path Constants" Type="Folder">
					<Item Name="Configuration File Path---Constant.vi" Type="VI" URL="../File Path Constant/Configuration File Path---Constant.vi"/>
					<Item Name="Data File Directory---Constant.vi" Type="VI" URL="../File Path Constant/Data File Directory---Constant.vi"/>
					<Item Name="Recovery File---Constant.vi" Type="VI" URL="../File Path Constant/Recovery File---Constant.vi"/>
					<Item Name="Create File Directories.vi" Type="VI" URL="../File Path Constant/Create File Directories.vi"/>
				</Item>
			</Item>
			<Item Name="Configuration Dialog Box.vi" Type="VI" URL="../Sub VI/Configuration Dialog Box.vi"/>
			<Item Name="Acquire Data_SubVI.vi" Type="VI" URL="../Sub VI/Acquire Data_SubVI.vi"/>
			<Item Name="Analyse Data_SubVI.vi" Type="VI" URL="../Sub VI/Analyse Data_SubVI.vi"/>
			<Item Name="Voltage Acquisition.vi" Type="VI" URL="../../../DataAcquisition&amp;Analysis/Voltage Acquisition.vi"/>
		</Item>
